""" Генерация двух случайных наборов числе
Выполнение оперций с наборами
"""
...
print(f'Элементы, которые входят в первое или во второе, \
но не в оба из них одновременно:\n {list2.symmetric_difference(list1)}') 
